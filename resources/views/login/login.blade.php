  ...
  <head>
    ...
    <style>
      ...
      body {
        padding-top: 40px;
        padding-bottom: 40px;
        background: url("{{url('img/fondo-login.jpg')}}") no-repeat center center fixed;
  ...
  <body>
    <div class="container" style="text-align:center;">
      {{Form::open(['url'=>'login', 'class'=>'form-signin', 'id'=>'frmLogin'])}}
        ...
        {{Form::label(null, 'PASSWORD: ', ['class'=>'sr-only'])}}
        {{Form::password('password', ['class'=>'form-control', 'placeholder'=>'PASSWORD', 'required'=>''])}}
        <br>
        {{Form::button('Limpiar', ['class'=>'btn btn-warning pull-left', 'type'=>'reset'])}}
        {{Form::button('Ingresar', ['class'=>'btn btn-primary pull-right', 'type'=>'submit'])}}
      {{Form::close()}}
