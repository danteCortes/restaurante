        ...
        <tbody>
          @foreach(App\Tienda::get() as $tienda)
            <tr>
              ...
              <td>{{$tienda->nombre}}</td>
              <td>
                <a class="ver" data-toogle="tooltip" title="Ver" data-id="{{$tienda->id}}">
                  <span class="fa fa-eye"> </span> </a>
                <a class="editar" data-toogle="tooltip" title="Editar" data-id="{{$tienda->id}}">
                  <span class="fa fa-edit"> </span> </a>
                <a class="eliminar" data-toogle="tooltip" title="Eliminar" data-id="{{$tienda->id}}">
